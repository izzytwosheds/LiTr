...
public class FrameSequenceAnimationOverlayFilter extends BaseOverlayGlFilter {
    ...
    /**
     * Create filter from an animation, then scale it, then position it, then rotate it
     * @param animationFrameProvider {@link AnimationFrameProvider} which provides animation frames and their durations
     ...
     */
    public FrameSequenceAnimationOverlayFilter(@NonNull AnimationFrameProvider animationFrameProvider, @NonNull PointF size, @NonNull PointF topLeftPosition, float rotation) {
